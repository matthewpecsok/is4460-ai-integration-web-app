...
SECRET_KEY = "django-insecure-$rk$r!0u454&p!t$1q&q12aa=@n8@ji8(wb-gam%$j=3hpds11"
...
MIDDLEWARE = [
    ...
    "shop.middleware.RequestJSONLoggingMiddleware",
...
LOGGING = {
    ...
    "formatters": {
        "json": {
            "()": "shop.logging_utils.JsonFormatter",
        },
    },
    "handlers": {
        "console": {
